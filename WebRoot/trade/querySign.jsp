...
<div class="container" style="margin-top: 10px">
    ...
    <form action="${ctx}/querySign.lz" target="_blank">
        <div class="from-group " style="margin-bottom: 10px">
            ...
            <%--<div class="row">--%>
                <%--<div class="col-md-6 ">--%>
                    <%--<div class="input-group ">--%>
                        <%--<span class="input-group-addon">FUNC_CODE功能号</span>--%>
                        <%--<input class="form-control" name="funcCode" value="1"/><br/>--%>
                    <%--</div>--%>
                <%--</div>--%>
            <%--</div>--%>
        ...
        <input class="btn btn-primary" type="submit" value="查询签约信息">
    </form>
